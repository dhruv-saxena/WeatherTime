...
You can choose the application size by modifying the Scale from 2-5. You can also choose the color for your application from blue, green, purple and red. Both these variables can also be set in the Details.txt file.
